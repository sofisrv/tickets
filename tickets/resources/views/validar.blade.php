...
<div class="col-sm-9 col-md-10 affix-content">
  ...
  <center><h3><span class="glyphicon glyphicon-check"></span></h3></center>
</div>

<?php
  $users = DB::table('pend')->get();
...
echo "<td><input type=submit class='btn btn-primary' name=yes value=Si> <input type=submit class='btn btn-primary' name=not value=No></td>"; 
echo "</form>";
echo"</tr>";  
}
echo"</tbody>";
