...
<div class="col-sm-9 col-md-10 affix-content">
  ...
  <center><h3><span class="glyphicon glyphicon-remove-circle"></span></h3></center>
</div>

<?php
  $users = DB::table('rip')->get();
...
echo "<form action='/informe'  target='_blank' method=POST>";
?>
...
echo "<input type=hidden name=pass  value='$r->estado'>";
echo "<input type=hidden name=tipe  value='$r->tipo'>";

//echo "<input type=hidden name=exis  value='$r->'>";



echo "<td><input type=submit class='btn btn-primary' name=yes value=Si> <input type=submit class='btn btn-primary' name=info value=Informe></td>"; 
echo "</form>";
echo"</tr>";  
}
echo"</tbody>";
