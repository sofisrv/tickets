...
</br><center><h3>Datos</h3></center></br>
...
<label class="control-label col-xs-3">Region:</label>   
    ...
    <div class="form-group">
        <div class="col-xs-offset-3 col-xs-9">
            <input type="submit" class="btn btn-default" style="width: 100%;" value="Actualizar">
    ...
    <div class="form-group">
        <div class="col-xs-offset-3 col-xs-9">
            ...
            <input type="reset" class="btn btn-default" style="width: 100%;" value="Limpiar">
        </div>
    </div>
    </center>
